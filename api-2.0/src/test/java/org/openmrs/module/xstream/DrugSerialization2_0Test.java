 ...
 */
public class DrugSerialization2_0Test extends BaseModuleContextSensitiveTest {
	...
	public void shouldSerializeDrug() throws Exception {
		...
		executeDataSet("org/openmrs/module/xstream/include/DrugSerialization2_0Test.xml");
		authenticate();
