...
public class ConceptMapSerialization1_10Test extends BaseModuleContextSensitiveTest {
	...
	public void shouldSerializeConceptMap() throws Exception {
		...
		executeDataSet("org/openmrs/module/xstream/include/ConceptMapSerializationTest1_10Test.xml");
		authenticate();
		...
		XMLAssert.assertXpathEvaluatesTo("23b6e712-49d8-11e0-8fed-18a905e044dc", "/conceptMap/@uuid", xmlOutput);
		XMLAssert.assertXpathEvaluatesTo("1", "/conceptMap/conceptMapId", xmlOutput);
		XMLAssert.assertXpathEvaluatesTo("75", "/conceptMap/conceptReferenceTerm/@id", xmlOutput);
        XMLAssert.assertXpathEvaluatesTo("2", "/conceptMap/conceptMapType/@id", xmlOutput);
	...
	public void shouldDeserializeConceptMap() throws Exception {
        ...
        xmlBuilder.append("        <personDateCreated class=\"sql-timestamp\" id=\"11\">2005-01-01 00:00:00 CST</personDateCreated>\n");
        xmlBuilder.append("        <personChangedBy reference=\"4\"/>\n");
        xmlBuilder.append("        <personDateChanged class=\"sql-timestamp\" id=\"12\">2007-09-20 21:54:12 CST</personDateChanged>\n");
