...
@OpenmrsProfile(openmrsVersion = "1.10")
 public class ConceptComplexSerialization1_10Test extends BaseModuleContextSensitiveTest {
	...
	public void shouldSerializeConceptComplex() throws Exception {
		...
		executeDataSet("org/openmrs/module/xstream/include/ConceptComplexSerialization1_10Test.xml");
		authenticate();
		...
		XMLAssert.assertXpathExists("/conceptComplex/answers/conceptAnswer[conceptAnswerId=1]", xmlOutput);
	...
	public void shouldDeserializeConceptComplex() throws Exception {
        ...
        xmlBuilder.append("<conceptComplex id=\"1\" uuid=\"0cbe2ed3-cd5f-4f46-9459-26127c9265ab\" retired=\"false\">\n");
		...
		assertEquals(sdf.parse("2008-08-15 7:27:51 CST"), cc.getDateCreated());
