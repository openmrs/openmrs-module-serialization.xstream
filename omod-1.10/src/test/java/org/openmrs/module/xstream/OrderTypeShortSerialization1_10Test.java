...
public class OrderTypeShortSerialization1_10Test extends BaseModuleContextSensitiveTest {
	...
	public void shouldOrderTypeShortSerialization() throws Exception {
		...
		executeDataSet("org/openmrs/module/xstream/include/OrderTypeShortSerialization1_10Test.xml");
		authenticate();
		...
		XMLAssert.assertXpathEvaluatesTo("2ca568f3-a64a-11e3-9aeb-50e549534c5e", "//order/orderType/@uuid", xmlOutput);
	...
	public void shouldOrderTypeShortDeserialization() throws Exception {
		 ...
		 * We also need to use the "OrderTypeShortSerialization1_10Test.xml" here
		 */
		initializeInMemoryDatabase();
		executeDataSet("org/openmrs/module/xstream/include/OrderTypeShortSerialization1_10Test.xml");
		authenticate();
