...
public class EncounterTypeShortSerialization1_10Test extends BaseModuleContextSensitiveTest {
	...
	public void shouldEncounterTypeShortSerialization() throws Exception {
		...
		executeDataSet("org/openmrs/module/xstream/include/EncounterTypeShortSerialization1_10Test.xml");
		authenticate();
	...
	public void shouldEncounterTypeShortDeserialization() throws Exception {
		 ...
		 * We also need to use the "EncounterTypeShortSerialization1_10Test.xml" here
		 */
		initializeInMemoryDatabase();
		executeDataSet("org/openmrs/module/xstream/include/EncounterTypeShortSerialization1_10Test.xml");
		authenticate();
