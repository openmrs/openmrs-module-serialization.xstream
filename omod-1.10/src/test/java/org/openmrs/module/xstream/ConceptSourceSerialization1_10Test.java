...
public class ConceptSourceSerialization1_10Test extends BaseModuleContextSensitiveTest {
	...
	public void shouldSerializeConceptSource() throws Exception {
		...
		executeDataSet("org/openmrs/module/xstream/include/ConceptSourceSerialization1_10Test.xml");
		authenticate();
